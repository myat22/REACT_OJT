...
class LineWebhookController extends Controller
{
    ...
    public function message(Request $request)
    {
        ...
        $responses = $bot->pushMessage('Uc57b5f35ad5156d765fc468848f4ac9b', $templateMessageBuilder);
        $responses = $bot->pushMessage('Uc57b5f35ad5156d765fc468848f4ac9b', $comfirmMessageBuilder);
